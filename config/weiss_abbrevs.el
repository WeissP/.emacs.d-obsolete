...
(define-abbrev-table 'org-mode-abbrev-table
  '(
    ("zrl" ":relaxed:" xah-elisp--ahf)
    ("zj" ":joy:" xah-elisp--ahf)
    ("zwa" "WhatsApp")
;;;;; for Germany language
    ...
    ("znm" "nochmal")
    ("znot" "Notation" xah-elisp--ahf)
    ("znx" "nächst" xah-elisp--ahf)
    ("zpb" "Problem" xah-elisp--ahf)
    ("zpg" "Programmier" xah-elisp--ahf)
...
(defun weiss-abbrevs-run ()
  ...
  (define-abbrev-table 'xah-elisp-mode-abbrev-table
    '(
      ...
      ("ignore-errors" "(ignore-errors ▮)" xah-elisp--ahf)
      ...
      ("lambda" "(lambda () (interactive) ▮)" xah-elisp--ahf)
