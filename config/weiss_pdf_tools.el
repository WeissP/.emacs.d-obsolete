  ...
  (defun weiss-pdf-command-mode-define-keys ()
    (weiss--define-keys
     ...
     '(
       ...
       ("," . (lambda()(interactive)(image-previous-line 2)))
       ("-" . pdf-view-shrink)
       ("." . (lambda()(interactive)(image-next-line 2)))
       ...
       ("j" . (lambda()(interactive)(pdf-view-next-page-command)(image-set-window-vscroll 0)))
       ("k" . (lambda()(interactive)(pdf-view-previous-page-command)(image-set-window-vscroll 0)))
