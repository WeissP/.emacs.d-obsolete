  ...
  (defun weiss-pdf-command-mode-define-keys ()
    (weiss--define-keys
     ...
     '(
       ...
       ("-" . pdf-view-shrink)
       ("." . (lambda()(interactive)(pdf-view-next-page-command)(image-set-window-vscroll 0)))
       ...
       ("j" . (lambda()(interactive)(image-next-line 2)))
       ("k" . (lambda()(interactive)(image-previous-line 2)))
