...
(wks-define-key
 ...
 '(
   ...
   ("d 1" .  org-roam-dailies-capture-today)
   ("d 2" .  org-roam-dailies-capture-tomorrow)
   ("d 3" .  org-roam-dailies-capture-date)
   ("d 8" .  org-roam-dailies-find-date)
   ("d 9" .  org-roam-dailies-find-yesterday)
   ("d 0" .  org-roam-dailies-find-today)
   ("d -" .  org-roam-dailies-find-tomorrow)
